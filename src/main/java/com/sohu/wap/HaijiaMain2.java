 ...
 *
 */
public class HaijiaMain2 
{
    private static Logger log = LoggerFactory.getLogger(HaijiaMain2.class);
    ...
    public static void main( String[] args ) throws InterruptedException, IOException
    {
        ...
        SpysHttpProxy.getInstance().getProxy();
        ...
        for (String accoutId: AccountMap.getInstance().getXueYuanAccountMap().keySet()){
            ...
            if ( xy!=null){
            	ProxyYueCheTask yueCheTask = new ProxyYueCheTask(xy,date);
